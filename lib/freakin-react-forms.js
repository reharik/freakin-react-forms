...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function (_React$Component) {
	  ...
	  function Form(props) {
	    ...
	    var fields = (0, _normalizeModel2.default)(props, {}, eventHandler);
	  ...
	  _createClass(Form, [{
	    ...
	    value: function componentWillUpdate(nextProps, nextState) {
	      this.newChildren = (0, _decorateInputs2.default)(nextProps.children, nextState.fields);
	    }
	  }, {
	    key: 'validateField',
	    ...
	    value: function onSubmitHandler(e) {
	      ...
	      e.preventDefault();
	      this.errors = [];
	      var newFieldsState = this.state.fields.map(function (x) {
	        x.errors = _this2.validateField(x, _this2.state.fields);
	        _this2.errors.concat(x.errors);
	        return x;
	      });
	...
	var _default = function _default(field, fields) {
	  ...
	  return field.rules.filter(function (rule) {
	    ...
	    return {
	      ...
	      message: (0, _errorMessages2.default)(field.name, field.value, rule),
	      rule: rule.rule
	    };
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeModel = function normalizeModel(props, data, events) {
	  var formName = props.formName || _uuid2.default.v4();
	  return model && props.model.map(function (x, i) {
