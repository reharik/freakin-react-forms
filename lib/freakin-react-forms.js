...
/***/ function(module, exports, __webpack_require__) {
	...
	var _trimModel = __webpack_require__(24);

	var _trimModel2 = _interopRequireDefault(_trimModel);
	...
	var Form = function (_React$Component) {
	  ...
	  _createClass(Form, [{
	    ...
	    value: function componentWillMount() {
	      var fields = (0, _normalizeModel2.default)(this.props.model, this.props.formName, this.eventHandler);
	    ...
	    value: function onSubmitHandler(e) {
	      ...
	      var newFieldsState = Object.keys(this.state.fields).map(function (x) {
	        return _this2.state.fields[x];
	      }).map(function (x) {

	        x.errors = _this2.validateField(x, _this2.state.fields);
	        _this2.errors = _this2.errors.concat(x.errors);
	        return x;
	...
	Form.propTypes = {
	  ...
	  submitHandler: _react.PropTypes.func.required
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeModel = function normalizeModel(model, _formName, events) {
	  var formName = _formName || _uuid2.default.v4();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var decorateInput = function decorateInput(children, model, shouldRerender) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dotted = __webpack_require__(19)(todots)
	var compact = __webpack_require__(22)(String)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var curry2 = __webpack_require__(20)
	var selectn = __webpack_require__(21)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var expressions = __webpack_require__(23)
