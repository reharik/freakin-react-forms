	...
	var Form = function (_React$Component) {
	  ...
	  function Form() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Form.__proto__ || Object.getPrototypeOf(Form)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	      ...
	      return (_this2 = _this).__onChangeHandler__REACT_HOT_LOADER__.apply(_this2, arguments);
	    }, _this.onBlurHandler = function () {
	      var _this3;

	      return (_this3 = _this).__onBlurHandler__REACT_HOT_LOADER__.apply(_this3, arguments);
	    }, _this.onSubmitHandler = function () {
	      var _this4;

	      return (_this4 = _this).__onSubmitHandler__REACT_HOT_LOADER__.apply(_this4, arguments);
	  ...
	  _createClass(Form, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      this.newChildren = (0, _decorateInputs2.default)(this.props.children, fields);
	    ...
	    value: function __onSubmitHandler__REACT_HOT_LOADER__(e) {
	      ...
	      var newFieldsState = Object.keys(fields).map(function (x) {
	        fields[x].errors = (0, _validationRunner2.default)(fields[x], _this5.state.fields);
	        _this5.errors = _this5.errors.concat(fields[x].errors);
	        return fields[x];
	      }).reduce(function (x, y) {
	        x[y.name] = y;return x;
	      }, {});
