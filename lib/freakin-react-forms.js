...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form2 = function Form2() {
	  ...
	  var handleChange = function handleChange(fieldName, value, change) {
	    var fields = undefined.props.fields;
	  ...
	  var onBlurHandler = function onBlurHandler(fields) {
	    return function (e) {
	      return e.target ? handleChange(e.target.name, e.target.value, fields) : null;
	    };
	  };
