	  ...
	  _createClass(Form, [{
	    ...
	    value: function onSubmitHandler(e) {
	      ...
	      var newFieldsState = this.state.fields.map(function (x) {
	        x.errors = (0, _validationRunner2.default)(x, _this2.state.fields);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  __REACT_HOT_LOADER__.register(validate, 'validate', '/home/rharik/Development/cannibal/freakin-react-forms/src/helpers/validation/validationRunner.js');
