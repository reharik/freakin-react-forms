...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form2 = function Form2() {
	  ...
	  var handleChange = function handleChange(fieldName, value, change, fields) {
	    var field = _extends({}, fields[fieldName]);
	    if (!field) {
	      return;
	    }
	    if (change) {
	    ...
	    return {
	      fields: Object.keys(fields).map(function (x) {
	        return fields[fieldName] ? field : fields[x];
	      }).reduce(function (x, y) {
	        x[y.name] = y;return x;
	      }, {}),
	  ...
	  var onChangeHandler = function onChangeHandler(e, fields) {
	    return e.target ? handleChange(e.target.name, e.target.value, true, fields) : null;
	  };

	  var onBlurHandler = function onBlurHandler(e, fields) {
	  ...
	  var buildModel = function buildModel(formName, model) {
	    return (0, _normalizeModel2.default)(formName, model, { onChangeHandler: onChangeHandler, onBlurHandler: onBlurHandler });
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeModel = function normalizeModel(formName, model) {
	  ...
	  return modelArray && modelArray.reduce(function (prev, next) {
	    prev[next.name] = next;
	    return prev;
	  }, {});
	};
