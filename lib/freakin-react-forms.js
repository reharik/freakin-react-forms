...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form2 = function () {
	  ...
	  var prepareSubmission = function prepareSubmission(fields) {
	    var errors = [];
	  ...
	  var buildModel = function buildModel(formName, model, events) {
	    return (0, _normalizeModel2.default)(formName, model, events);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var normalizeModel = function normalizeModel(formName, model, events) {
	  ...
	  return modelArray && modelArray.map(function (x) {
	    return _extends({}, x, events);
